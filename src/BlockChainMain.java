...
public class BlockChainMain {
	...
	public static void main(String[] args) 
	{
		...
		MyFirstBlock.blockTransactionValidator(MyFirstBlock.CalculatePreviousHash(),MyGenesisBlock.CalculateHash());
		...
		MyFirstBlock.blockTransactionValidator(MySecoundBlock.CalculatePreviousHash(),MyFirstBlock.CalculatePreviousHash());
		...
		MyFirstBlock.blockTransactionValidator(MyThirdBlock.CalculatePreviousHash(),MySecoundBlock.CalculatePreviousHash());
		System.out.println("Enter the data you want to store?");
		...
		MyFirstBlock.blockTransactionValidator(MyFourthBlock.CalculatePreviousHash(),MyThirdBlock.CalculatePreviousHash());
		System.out.println("Enter the data you want to store?");
